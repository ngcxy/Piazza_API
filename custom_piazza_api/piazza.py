...
class Piazza(object):
    ...
    """
    def __init__(self, piazza_rpc=None, session=None):
        self._rpc_api = piazza_rpc if piazza_rpc else PiazzaRPC()
        self._rpc_api.session = session if session else requests.Session()
